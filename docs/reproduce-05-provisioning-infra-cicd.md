...
## Provisioning Infra CI/CD

### Clean Cache

- Goto `terraform/environment/providers/aws/infra/resources/cicd` folder

      cd terraform/environment/providers/aws/infra/resources/cicd

- Cleanup Cache Terraform

      rm -rf .terraform .terraform.lock.hcl terraform.cicd.d
